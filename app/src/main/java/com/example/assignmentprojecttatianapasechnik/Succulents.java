...
// inicialise navigation menu on top of the page, set onClick listeners
        TextView flowersCategury = (TextView) findViewById(R.id.toFlowerignPlants);
        flowersCategury.setOnClickListener(toFlowers);
    ...
    private void initDataSucculents() {
        ...
        succulentssList.add(new ModelClassSucculent(R.drawable.echeveria_lilacina, "Echeveria Lilacina", "Crassulaceae", "Silvery Grey/Lilac"));
        succulentssList.add(new ModelClassSucculent(R.drawable.echeveria_green_rose, "Echeveria Elegans", "Crassulaceae", "Green"));
        succulentssList.add(new ModelClassSucculent(R.drawable.echeveria_lilly, "Echeveria Water Lily", "Crassulaceae", "Green/Pink"));
        succulentssList.add(new ModelClassSucculent(R.drawable.echeveria_elegance, "Echeveria Green Rose", "Crassulaceae", "Green"));
        succulentssList.add(new ModelClassSucculent(R.drawable.sedum_gold, "Sedum Gold Mound", "Sedum", "Green/Yellow"));
        succulentssList.add(new ModelClassSucculent(R.drawable.succulent_dark, "Aeonium Schwarzkopf", "Aeonium", "Dark Brown"));
        succulentssList.add(new ModelClassSucculent(R.drawable.jade_plant, "Senecio Jacobsenii", "Asteraceae", "Green"));
        succulentssList.add(new ModelClassSucculent(R.drawable.echeveria_black_knight, "Echeveria Black Knight", "Crassulaceae", "Dark Brown"));
        succulentssList.add(new ModelClassSucculent(R.drawable.sedum_big, "Sedum Hispanicum", "Sedum", "Blue/Green"));
        succulentssList.add(new ModelClassSucculent(R.drawable.succulent_green_round, "Sedum Rubrotinctum", "Sedum", "Green"));
    ...
    public void onItemClick(int position) {
        if (position==0)
        {
            ...
            intent.putExtra("link", "Back To Succulents");
            // set up transition, make picture expand when opening plant description, and go smaller, when goig back from description.
            ActivityOptionsCompat compat = ActivityOptionsCompat.makeSceneTransitionAnimation(Succulents.this,findViewById(R.id.succulent_picture),"trans1");
