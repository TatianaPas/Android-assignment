...
public class HousePlants extends AppCompatActivity implements CustomAdapter.OnItemListener {
    ...
    private void initData() {
        ...
        plantsList.add(new ModelClass(R.drawable.turntles,"String of Turtles","Average to High", "15-20", "Medium to Bright"));
        plantsList.add(new ModelClass(R.drawable.thymus_door,"Thymus","Medium", "Average", "Medium to Bright"));
        plantsList.add(new ModelClass(R.drawable.pratia_country,"Thymus Something","Normal", "18-27", "Low Light"));
        plantsList.add(new ModelClass(R.drawable.thymus2,"Thymus Variegated","High", "Above 12", "Medium to Bright"));
        plantsList.add(new ModelClass(R.drawable.falls,"Ficus","Normal", "10-15", "Medium to Bright"));
        plantsList.add(new ModelClass(R.drawable.pratia_rubella,"ZZ Plant","Average", "15-24", "Low to Bright"));
        plantsList.add(new ModelClass(R.drawable.scleranthus,"Maranta","Mist frequently", "15-23", "Low to Medium"));
        plantsList.add(new ModelClass(R.drawable.thymus_poly,"Syngonium","High", "16-18", "Medium to Bright"));
        plantsList.add(new ModelClass(R.drawable.pratia_angulata,"Calathea","Mist Regularly", "16-23", "Medium"));
        plantsList.add(new ModelClass(R.drawable.thymus1,"Alocasia","Mist Occasionally", "18-24", "Bright Indirect"));
    }
