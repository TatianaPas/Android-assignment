...
public class HousePlants extends AppCompatActivity implements CustomAdapter.OnItemListener {
    ...
    public void onItemClick(int position) {
        if (position==0)
        {
            ...
            intent.putExtra("BackgroundPhoto", R.drawable.monsterra);
            ...
            intent.putExtra("BackgroundPhoto", R.drawable.peperomia);
            ...
            intent.putExtra("BackgroundPhoto", R.drawable.birkin2);
            ...
            intent.putExtra("BackgroundPhoto", R.drawable.ficus);
            ...
            intent.putExtra("BackgroundPhoto", R.drawable.zzplant);
            ...
            intent.putExtra("BackgroundPhoto", R.drawable.maranta1);
            ...
            intent.putExtra("BackgroundPhoto", R.drawable.syngonium2);
            ...
            intent.putExtra("BackgroundPhoto", R.drawable.calathea);
            ...
            intent.putExtra("BackgroundPhoto", R.drawable.alocasia2);
